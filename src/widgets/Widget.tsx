...
export function globalSvgContent(globalContentId: string) {
  return (
    <>
      <marker
        id={`connector-association-${globalContentId}`}
        markerWidth="10"
        markerHeight="7"
        refX="9"
        refY="3.5"
      ...
      <marker
        id={`connector-composition-${globalContentId}`}
        markerWidth="12"
        markerHeight="8"
        refX="11"
        refY="4"
      ...
      <marker
        id={`connector-inheritance-${globalContentId}`}
        markerWidth="12"
        markerHeight="10"
        refX="11"
        refY="5"
      ...
      <defs>
        <filter
          id={`connector-text-background-blur-${globalContentId}`}
          x="-50%"
          y="-50%"
          width="200%"
          height="200%"
