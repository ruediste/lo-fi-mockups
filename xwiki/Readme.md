...
Run the `Build XWiki extension (with new version)` VS Code task. It will build the extension with a new version. Open the extension manager in xwiki, click on `More` and `Advanced Search`. Enter the extension id
